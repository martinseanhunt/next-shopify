...
import { COLLECTIONS_QUERY } from '../components/Collection'
...
// We want the data from these queries on all pages so we can do that here to avoid
// having to pass them down on every SSG / SSR page.
